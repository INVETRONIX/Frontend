package com.project.frontend.registroProveedores.controllers;
...
import com.project.frontend.registroProveedores.services.IProveedoresService;
import com.project.frontend.registroProveedores.services.ProveedoresService;
...
public class ControllerProveedor {
    ...
    public void saved(Proveedor proveedor){
        new Thread(() -> {
            try {
