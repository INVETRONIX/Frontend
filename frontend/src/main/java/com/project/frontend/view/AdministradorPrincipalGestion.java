 ...
 * @author juan
 */
public class AdministradorPrincipalGestion extends javax.swing.JFrame {

    /**
     * Creates new form AdministradorPrincipalGestion
     */
    public AdministradorPrincipalGestion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setFont(new java.awt.Font("Dyuthi", 1, 36)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministradorPrincipalGestion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministradorPrincipalGestion().setVisible(true);
            }
        });
    }
